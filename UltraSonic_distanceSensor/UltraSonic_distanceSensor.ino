...
VCC to arduino 5v GND to arduino GND Echo to Arduino pin 7 Trig to Arduino pin 8
*/
...
delayMicroseconds(2); digitalWrite(trigPin, HIGH); delayMicroseconds(10); digitalWrite(trigPin, LOW); duration = pulseIn(echoPin, HIGH);
...
/* Send the distance to the computer using Serial protocol, and turn LED OFF to indicate successful reading. */ Serial.println("Dustbin is at distance of"); Serial.println(distance);
